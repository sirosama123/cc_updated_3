                ...
                GestureDetector(
                  onTap: () async{
                    ...
                    chatRoom.add({
                     ...
                     FirebaseFirestore db = FirebaseFirestore.instance;
                        await db.collection("users").doc(Provider11.uid).collection("chatPersons").doc(uid).set({
                      ...
                      await db.collection("vendors").doc(uid).collection("chatPersons").doc(Provider11.uid).set({
